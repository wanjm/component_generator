...
class WidgetBuilder extends GeneratorForAnnotation<TableWidget> {
  ...
  FutureOr<String> generateForAnnotatedElement(
    ...
    if (fetchClassType != null && fetchMethodName.isNotEmpty) {
      // Type-based approach: fetchClass: OrgBiz, fetchMethodName: "listOrg"
      final className =
          fetchClassType.getDisplayString(withNullability: false);
      // Use singleton instance generated by NetworkBuilder:
      // e.g. OrgBiz -> orgBizFetch (instance of OrgBizFetch)
      final instanceName =
          "${className[0].toLowerCase()}${className.substring(1)}Fetch";
      fetchMethod = "$instanceName.$fetchMethodName";
    }
